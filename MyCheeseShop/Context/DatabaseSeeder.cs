...
namespace MyCheeseShop.Context
{
    ...
    public class DatabaseSeeder
    {
        ...
        private List<Cheese> GetCheeses()
        {
            ...
            new Cheese { Name = "Roquefort", Type = "Blue", Description = "Intensely creamy and tangy", Strength = "Strong", Price = 12.99m, ImageUrl="roquefort.png" },
            ...
            new Cheese { Name = "Gruyere", Type = "Hard", Description = "Rich and creamy with nutty flavor", Strength = "Medium", Price = 10.49m, ImageUrl="gruyere.png" },
